...
class PasswordFieldNoError extends StatefulWidget {
  PasswordFieldNoError({
    this.autoFocus = false,
    this.border,
    this.focusedBorder,
    this.color,
  ...
  /// changes the primary color of the PasswordFieldNoError
  final Color color;
  ...
  /// A controller for an editable passwordfieldNoError.
  final TextEditingController controller;
  ...
  ///default text to show on the passwordfieldNoError
  /// This hint is hidden/does not take effect if [hasFloatingPlaceholder] = true
  final String hintText;
  ...
  /// styling the PasswordfieldNoError Text
  final TextStyle inputStyle;
  ...
  /// A Callback function triggered when the text insude the PasswordFieldNoError changes
  ///
  @deprecated
  final Function onChanged;
  ...
  @override
  State createState() {
    return PasswordFieldNoErrorState();
  }
}

class PasswordFieldNoErrorState extends State<PasswordFieldNoError> {
  bool obscureText = true;
//wrap your toggle icon in Gesture Detector
